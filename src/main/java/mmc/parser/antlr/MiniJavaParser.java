...
public class MiniJavaParser extends Parser {
	...
	public static final int
		...
		RULE_local_var_decl_concat = 17, RULE_if_else_statement = 18, RULE_if_else_statement_inline = 19, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"if_else_statement", "if_else_statement_inline", "else_statement", "while_statement", 
	...
	public static class Statement_block_inlineContext extends ParserRuleContext {
		...
		public List<Statement_inlineContext> statement_inline() {
			return getRuleContexts(Statement_inlineContext.class);
		}
		public Statement_inlineContext statement_inline(int i) {
			return getRuleContext(Statement_inlineContext.class,i);
		}
	...
	public static class Statement_inlineContext extends ParserRuleContext {
		public If_else_statement_inlineContext if_else_statement_inline() {
			return getRuleContext(If_else_statement_inlineContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class If_else_statement_inlineContext extends ParserRuleContext {
		public TerminalNode IF() { return getToken(MiniJavaParser.IF, 0); }
		public TerminalNode LEFT_BRACKET() { return getToken(MiniJavaParser.LEFT_BRACKET, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		...
		public If_else_statement_inlineContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_if_else_statement_inline; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniJavaListener ) ((MiniJavaListener)listener).enterIf_else_statement_inline(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniJavaListener ) ((MiniJavaListener)listener).exitIf_else_statement_inline(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiniJavaVisitor ) return ((MiniJavaVisitor<? extends T>)visitor).visitIf_else_statement_inline(this);
			else return visitor.visitChildren(this);
		}
	}

	public final If_else_statement_inlineContext if_else_statement_inline() throws RecognitionException {
		If_else_statement_inlineContext _localctx = new If_else_statement_inlineContext(_ctx, getState());
		enterRule(_localctx, 38, RULE_if_else_statement_inline);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(336);
