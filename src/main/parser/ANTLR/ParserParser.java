...
public class ParserParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, MUL=3, ADD=4, SUB=5, Number=6, WS=7;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "MUL", "ADD", "SUB", "Number", "WS"
		};
	}
	...
	public static class SContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).enterS(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ParserListener ) ((ParserListener)listener).exitS(this);
		}
		@Override
